        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between hover:shadow-md transition-shadow">
          ...
          <div className="flex items-center gap-2">
            {(search || statusFilter) && (
              <button
                onClick={handleReset}
                className="inline-flex items-center justify-center gap-1.5 px-4 py-2 border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-xl text-sm font-semibold transition-all cursor-pointer"
              >
